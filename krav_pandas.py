...
df = pd.read_csv('C:/Users/zeron/Documents/Python/krav-manager/testekravmaga.csv')
...
def inserir_aluno(Aluno):
    ...
    global df
    df = df.append(novo_aluno, ignore_index=True)
    df.to_csv('C:/Users/zeron/Documents/Python/krav-manager/testekravmaga.csv')
    #print(df2.tail(2))
...
def print_dataframe(lista):
    for i in range(len(lista)):
        ...
        nome_completo = str(aluno[2] + ' ' + aluno[3])
